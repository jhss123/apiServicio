...
namespace apiServicio
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ItrnIngresoDetalleRepository, trnIngresoDetalleRepository>();
            services.AddTransient<ITrnIngresoDetalleService, TrnIngresoDetalleService>();
